...
class leonardo_value_bot_4 : public leonardo_value_bot
{
private:
	...
	float eval_4(const ChessBoard& board, const UniqueMoveList& moves);
...
public:
	leonardo_value_bot_4(int ms_per_move);
